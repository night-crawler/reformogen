...
export const FORMOGEN_COMPONENT_DID_MOUNT = `${ACTION_PREFIX}:DID_MOUNT`;
export const FORMOGEN_COMPONENT_WILL_UNMOUNT = `${ACTION_PREFIX}:WILL_UNMOUNT`;
...
export const METADATA_REQUEST_START = `${ACTION_PREFIX}:METADATA_REQUEST:${START}`;
export const METADATA_REQUEST_FAIL = `${ACTION_PREFIX}:METADATA_REQUEST:${FAIL}`;
export const METADATA_REQUEST_SUCCESS = `${ACTION_PREFIX}:METADATA_REQUEST:${SUCCESS}`;
...
export const FORMDATA_REQUEST_START = `${ACTION_PREFIX}:FORMDATA_REQUEST:${START}`;
export const FORMDATA_REQUEST_FAIL = `${ACTION_PREFIX}:FORMDATA_REQUEST:${FAIL}`;
export const FORMDATA_REQUEST_SUCCESS = `${ACTION_PREFIX}:FORMDATA_REQUEST:${SUCCESS}`;
...
// FORM SUBMIT
export const FORM_SUBMIT_INIT = `${ACTION_PREFIX}:FORM_SUBMIT:INIT`;
export const FORM_SUBMIT_COMPLETE = `${ACTION_PREFIX}:FORM_SUBMIT:COMPLETE`;
...
// FORMDATA SEND
export const FORMDATA_SEND_START = `${ACTION_PREFIX}:FORMDATA_SEND:${START}`;
export const FORMDATA_SEND_FAIL = `${ACTION_PREFIX}:FORMDATA_SEND:${FAIL}`;
export const FORMDATA_SEND_SUCCESS = `${ACTION_PREFIX}:FORMDATA_SEND:${SUCCESS}`;
export const FORMDATA_SEND_SKIP = `${ACTION_PREFIX}:FORMDATA_SEND:SKIP`;
export const FORMDATA_SEND_OTHER_NETWORK_ERROR = `${ACTION_PREFIX}:FORMDATA_SEND:OTHER_NETWORK_ERROR`;
...
// FORMFILES PROCESS
export const FORMFILES_PROCESS_START = `${ACTION_PREFIX}:FORMFILES_PROCESS:${START}`;
export const FORMFILES_PROCESS_SUCCESS = `${ACTION_PREFIX}:FORMFILES_PROCESS:${SUCCESS}`;
export const FORMFILES_PROCESS_SKIP = `${ACTION_PREFIX}:FORMFILES_PROCESS:SKIP`;
...
// SINGLE FILE UPLOAD
export const SINGLE_FILE_UPLOAD_START = `${ACTION_PREFIX}:SINGLE_FILE_UPLOAD:${START}`;
export const SINGLE_FILE_UPLOAD_FAIL = `${ACTION_PREFIX}:SINGLE_FILE_UPLOAD:${FAIL}`;
export const SINGLE_FILE_UPLOAD_SUCCESS = `${ACTION_PREFIX}:SINGLE_FILE_UPLOAD:${SUCCESS}`;
...
// SINGLE FILE DELETE
export const SINGLE_FILE_DELETE_START = `${ACTION_PREFIX}:SINGLE_FILE_DELETE:${START}`;
export const SINGLE_FILE_DELETE_FAIL = `${ACTION_PREFIX}:SINGLE_FILE_DELETE:${FAIL}`;
export const SINGLE_FILE_DELETE_SUCCESS = `${ACTION_PREFIX}:SINGLE_FILE_DELETE:${SUCCESS}`;
...
export const FIELD_CHANGED = `${ACTION_PREFIX}:FIELD_CHANGED`;
