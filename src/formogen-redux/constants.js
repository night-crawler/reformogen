...
export const FETCH_FIELD_OPTIONS = `${PREFIX}/FETCH_FIELD_OPTIONS`;
export const FETCH_FIELD_OPTIONS_SUCCESS = `${PREFIX}/FETCH_FIELD_OPTIONS_SUCCESS`;
export const FETCH_FIELD_OPTIONS_ERROR = `${PREFIX}/FETCH_FIELD_OPTIONS_ERROR`;


export const FETCH_MORE_FIELD_OPTIONS = `${PREFIX}/FETCH_MORE_FIELD_OPTIONS`;
export const FETCH_MORE_FIELD_OPTIONS_SUCCESS = `${PREFIX}/FETCH_MORE_FIELD_OPTIONS_SUCCESS`;
export const FETCH_MORE_FIELD_OPTIONS_ERROR = `${PREFIX}/FETCH_MORE_FIELD_OPTIONS_ERROR`;
